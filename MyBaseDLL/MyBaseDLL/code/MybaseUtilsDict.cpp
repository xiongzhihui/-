...
/****************************************************************************
**
**	MyBaseUtils::getRegularDictionaryId
...
AcDbObjectId
MyBaseUtils::getRegularDictionaryId(LPCTSTR dictName, bool createIfNotFound, AcDbDatabase* db)
{
	ASSERT(db != NULL);
...
/****************************************************************************
**
**  MyBaseUtils::getSubDictionaryId
**
**  **jma
**
*************************************/
...
AcDbObjectId
MyBaseUtils::getSubDictionaryId(LPCTSTR dictName, bool createIfNotFound,
...
/****************************************************************************
**
**	MyBaseUtils::openDictionaryForRead
...
AcDbDictionary*
MyBaseUtils::openDictionaryForRead(LPCTSTR dictName, AcDbDatabase* db)
{
	ASSERT(db != NULL);
...
AcDbDictionary*
MyBaseUtils::openDictionaryForRead(LPCTSTR dictName, const AcDbObjectId& parentDictId)
{
...
AcDbDictionary*
MyBaseUtils::openDictionaryForRead(LPCTSTR dictName, AcDbDictionary* parentDict)
{
    ASSERT(dictName != NULL);
    ASSERT(parentDict != NULL);
...
/****************************************************************************
**
**	MyBaseUtils::openDictionaryForWrite
...
AcDbDictionary*
MyBaseUtils::openDictionaryForWrite(LPCTSTR dictName, bool createIfNotFound, AcDbDatabase* db)
{
	ASSERT(db != NULL);
...
AcDbDictionary*
MyBaseUtils::openDictionaryForWrite(LPCTSTR dictName, bool createIfNotFound, const AcDbObjectId& parentDictId)
{
    ASSERT(dictName != NULL);
    if (parentDictId == AcDbObjectId::kNull)
        return NULL;
...
AcDbDictionary*
MyBaseUtils::openDictionaryForWrite(LPCTSTR dictName, bool createIfNotFound,
                                            AcDbDictionary* parentDict)
{
    ASSERT(dictName != NULL);
    ASSERT(parentDict != NULL);
    ...
    if (es == Acad::eOk) {
        ...
        if (createIfNotFound) {
            ...
            if (es != Acad::eOk) {
                acutPrintf(_T("\nERROR: could not create dictionary \"%s\" (%s)"), dictName, MyBaseUtils::rxErrorStr(es));
                delete dict;
                dict = NULL;
            }
        }
...
/****************************************************************************
**
**	MyBaseUtils::collectDictionaryEntryNames
...
//Acad::ErrorStatus
//MyBaseUtils::collectDictionaryEntryNames(const AcDbObjectId& dictId, SdStrObjIdList& list, AcRxClass* classType)
//{
...
//
//Acad::ErrorStatus
//MyBaseUtils::collectDictionaryEntryNames(const AcDbObjectId& dictId, AcDbObjectIdArray& list, AcRxClass* classType)
//{
//	Acad::ErrorStatus ret = Acad::eInvalidInput;
//
//	AcDbDictionary* dict;
...
/****************************************************************************
**
**	MyBaseUtils::lookUpDictEntryName
...
bool
MyBaseUtils::lookUpDictEntryName(const AcDbObjectId& objId, CString& entryName)
{
    bool retCode = FALSE;
    AcDbObject* obj;
...
/****************************************************************************
**
**	MyBaseUtils::openExtDictForRead
**
**	**jma
**
*************************************/
...
AcDbDictionary*
MyBaseUtils::openExtDictForRead(const AcDbObject* obj)
{
    ASSERT(obj != NULL);
...
/****************************************************************************
**
**	MyBaseUtils::openExtDictForWrite
...
AcDbDictionary*
MyBaseUtils::openExtDictForWrite(AcDbObject* obj, bool createIfNotFound)
{
    ASSERT(obj != NULL);
